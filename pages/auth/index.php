...
<!--    กำหนด client ID ที่เราได้สร้างไว้-->
    <meta name="google-signin-client_id" content="584689131463-qgtl775eq4d7ql9murb4kchhudr0lck4.apps.googleusercontent.com">
...
<?php } ?>
    ...
    <script>
        var urlDirect="http://localhost/parttime/pages/auth/index.php"; // หนัาที่ต้องการให้แสดงหลังล็อกอิน
